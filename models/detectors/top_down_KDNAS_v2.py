...
class TopDownKDNASv2(BasePose):
    ...
    def __init__(self,
        ...
        if keypoint_head is not None:
            ...
            self.keypoint_head_1024 =  builder.build_head(keypoint_head_1024)
    ...
    def init_weights_l(self, pretrained=None):
        ...
        load_state_dict(self.keypoint_head_1024, ckpt_k)

        self.backbone_l.eval()
        self.keypoint_head_l.eval()
        self.keypoint_head_1024.eval()
    ...
    def forward_train(self, img, target, target_weight, img_metas, **kwargs):
        ...
        if self.with_keypoint:
            ...
            with torch.no_grad():
                ...
                output_1024 = self.keypoint_head_1024(origin_out[2])
        ...
        if self.with_keypoint:
            ...
            #print(output_1024.size())
            #print(output_l.size())
            keypoint_losses['50s3to152s4_loss'] = self.keypoint_head.get_loss(output_1024, output_l, target_weight) * 0.2 # output 50 s3 --> output res 152  loss
