...
class TopDownEHDistill(BasePose):
    ...
    def forward_train(self, img, target, target_weight, img_metas, alpha=0.5, **kwargs):
        ...
        with torch.no_grad():
            ...
            Extra_output_t = self.keypoint_head_Extra_teacher(origin_output_t[2])
        ...
        if self.with_keypoint:
            ...
            keypoint_losses['Stage3_loss'] = self.keypoint_head.get_loss(Extra_output, Extra_output_t, target_weight_KD)/3
